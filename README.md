...
This repository contains some of the tasks carried out during the course of AI2 for medical data analysis, including classification and regression tasks on healthcare datasets. These are some of my very first projects, therefore **the coding style is rather crude.** If you want to read the full report on the project feel free to contact me.
